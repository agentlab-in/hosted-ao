    ...
    ({
      ...
      const ao = {
        ...
        machines: {
          getState: async () => ({
            ...signedOutAoMachines,
            machines: [...signedOutAoMachines.machines, ...pairedList],
          }),
          refresh: async () => ({
            ...signedOutAoMachines,
            machines: [...signedOutAoMachines.machines, ...pairedList],
        ...
        pairedMachines: pairing
          ...
          : {
              ...
              add: async () => {
                throw new Error(
                  "Pairing is unavailable under the browser harness.",
                );
              },
              remove: async () => {},
            },
