...
// session's tmux pane over a PTY and multiplexes the byte stream to one or more
...
//   - The PTY itself is reached through PTYSource (satisfied by the tmux runtime
