...
func TestIntakeControlRouteMethodsNeverReachDaemon(t *testing.T) {
...
func TestIntakeControlSiblingsRequireAuthentication(t *testing.T) {
	for _, path := range []string{"/api/v1/system/installers", "/api/v1/agents/installers-extra", "/api/v1/agents/claude-code/install-info"} {
