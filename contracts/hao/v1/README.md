...
| Prerequisites | `prerequisites.json` | Git and a harness are required; `gh` is profile-conditional; AO owns its runtime implementation. |
...
| desktop / `hao` | gateway | `gateway-route-policy` | manifest version | v1 |
| `hao` | legacy service | `legacy-installation-shape` | fixture shape | v1 |
